...
final class AppCoordinator: BaseCoordinator, RouteHandlingCoordinator {
    ...
    override func start() {
        ...
        profileNav.tabBarItem = UITabBarItem(title: ProfileView.navigationTitle, image: UIImage(systemName: "person.crop.circle"), selectedImage: UIImage(systemName: "person.crop.circle.fill"))
